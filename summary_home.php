...
<div id="container">
	<div id="content">
		...
		<div class="alignleft" style="margin:10px 0;font-weight:bold;"><?php next_posts_link('&laquo; Older posts') ?></div>
		<div class="alignright" style="margin:10px 0;font-weight:bold;"><?php previous_posts_link('Newer posts &raquo;') ?></div>

		<div class="post-header" style="margin-top:20px;clear:both;">
